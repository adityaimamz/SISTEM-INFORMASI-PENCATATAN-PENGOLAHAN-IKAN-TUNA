    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/admin"><img src="{{ asset('img/logo.png') }}" alt="Logo"
                            srcset=""></a>
                </div>
            ...
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::is('admin') ? 'active' : '' }} ">
                    <a href="/admin" class='sidebar-link'>
                        ...
                        <span>Dashboard {{ Auth::user()->role_id == 1 ? 'Admin' : 'Karyawan' }}</span>
                    </a>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Service</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="component-breadcrumb.html" class="submenu-link">Packing</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="component-button.html" class="submenu-link">Produk Keluar</a>
