            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-outline-primary block" data-bs-toggle="modal" data-bs-target="#tambahProdukKeluarModal">
                            Tambah Produk Keluar
                        </button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="no_box" class="form-control border-primary" required>
                                                    @foreach ($packings as $packing)
                                                        <option value="{{ $packing->id }}">{{ $packing->id }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('produk-keluar.update', $item->id) }}" enctype="multipart/form-data" class="mt-0">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="no_box" class="form-control border-primary" required>
                                                                    @foreach ($packings as $packing)
                                                                        <option value="{{ $packing->id }}" {{ $packing->id == $item->no_box ? 'selected' : '' }}>{{ $packing->id }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
