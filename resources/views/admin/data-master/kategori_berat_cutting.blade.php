                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('kategori_berat_cutting.store') }}"
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table" id="table2">
                                ...
                                <tbody>
                                    @foreach ($kategori_berat_cutting as $item)
                                        <tr>
                                        ...
                                        <div class="modal fade" id="editKategoriBeratModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('kategori_berat_cutting.update', $item->id) }}"
                                                            enctype="multipart/form-data" class="mt-0">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('kategori_berat_cutting.destroy', $item->id) }}"
                                                            class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
