            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-subtitle text-muted">Data produk</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="table2">
                                <thead class="bg-light">
                                    <tr>
                                        <th style="witdh: 50px;">No</th>
                                        <th>Nama Produk</th>
                                        <th class="text-center" style="witdh: 100px;">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr style="background: linear-gradient(to right, #f9f9f9 0%, #f0f7ff 100%);">
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal" 
                                                data-bs-target="#editModal{{ $kategoriProduk->kategori_produk_id }}">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <form action="{{ route('kategori-produk.destroy', $kategoriProduk->kategori_produk_id) }}" 
                                    ...
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="editModal{{ $kategoriProduk->kategori_produk_id }}" tabindex="-1" role="dialog" 
                                        aria-labelledby="editModalLabel{{ $kategoriProduk->kategori_produk_id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background: linear-gradient(135deg, #f6d365 0%, #fda085 100%);">
                                                    <h5 class="modal-title" id="editModalLabel{{ $kategoriProduk->kategori_produk_id }}">Edit Produk</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="{{ route('kategori-produk.update', $kategoriProduk->kategori_produk_id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="edit_nama_produk" name="nama_produk" 
                                                                value="{{ $kategoriProduk->nama_produk }}" required>
                                                        </div>
    ...
    <div class="modal fade" id="tambahByprodukCtModal" tabindex="-1" role="dialog" 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('kategori-produk.store') }}" class="mt-3">
                        @csrf
                        <div class="mb-3">
