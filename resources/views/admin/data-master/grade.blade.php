            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Data Master Grade </h3>
                        <p class="text-subtitle text-muted">Silahkan kelola data grade</p>
                    </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="tambahIkanModalTitle">Tambah Grade</h5>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="hapusIkanModalTitle{{ $item->id }}">Hapus Grade</h5>
                                                        <button type="button" class="close" data-bs-dismiss="modal"
                                                            aria-label="Close">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Apakah Anda yakin ingin menghapus grade ini?</p>
                                                    </div>
